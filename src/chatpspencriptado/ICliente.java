...
public class ICliente extends javax.swing.JFrame {
    ...
    public ICliente(SSLContext sc) {
        ...
        try {
            ...
            //Le damos titulo al cliente
            setTitle("Client");
            //Hago el Frame visible poniendolo a true
            setVisible(true);
            readMessage();
    ...
    private void TextFieldCActionPerformed(java.awt.event.ActionEvent evt) {
